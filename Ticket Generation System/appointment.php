		...
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-md-2" align="right">
					<button type="button" id="createAppointment" class="btn btn-success" title="CREATE TICKETS"><span class="glyphicon glyphicon-plus">Add</span></button>
				</div>
				<?php } ?>
			</div>
		</div>
    			...
    			<div class="modal-content">
    				...
    				<div class="modal-body">
						<div class="form-group"
							<label for="patient_name" class="control-label">USER</label>
						...
						<div class="form-group"
							<label for="doctor" class="control-label">ADMIN</label>
						...
						<div class="form-group">
							<label for="specialization" class="control-label">DEPARTMENT</label>							
						...
						<div class="form-group">
							<label for="fee" class="control-label">ID</label>							
							<input type="text" class="form-control" id="fee" name="fee" placeholder="ID">							
						</div>	   	
						<div class="form-group">
							<label for="appointment_date" class="control-label">TICKET ISSUE Date</label>							
							<input type="date" class="form-control"  id="appointment_date" name="appointment_date" value="<?php echo date('d-m-Y'); ?>">					
							
						</div>						
  
						<div class="form-group">
							<label for="appointment_slot" class="control-label">TICKET Slots</label>							
    	...
    	<div class="modal-dialog">    		
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><i class="fa fa-plus"></i> TICKET Details</h4>
				</div>
				<div class="modal-body">
					<div class="form-group">
					...
					<div class="form-group">
						<label for="p_gender" class="control-label">USER:</label>				
						<span id="a_doctor"></span>							
					</div>	   	
					<div class="form-group">
						<label for="p_age" class="control-label">DEPARTMENT:</label>							
						<span id="a_special"></span>								
					</div>	
					<div class="form-group">
						<label for="a_fee" class="control-label">COST:</label>							
						<span id="a_fee"></span>								
					</div>	
					<div class="form-group">
						<label for="phone" class="control-label">TICKET Date Time:</label>							
						<span id="a_time"></span>					
					</div>			
					<div class="form-group">
