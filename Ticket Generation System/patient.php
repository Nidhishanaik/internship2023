		...
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-md-2" align="right">
					<button type="button" id="addPatient" class="btn btn-success" title="Add USERS"><span class="glyphicon glyphicon-plus">Add</span></button>
				</div>
				<?php } ?>
			</div>
		</div>
    		...
    		<form method="post" id="patientForm">
    			<div class="modal-content">
    				...
    				<div class="modal-body">
						...
						<div class="form-group">
							<label for="description" class="control-label">ACTION</label>							
    	...
    	<div class="modal-dialog">    		
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><i class="fa fa-plus"></i> USERS Details</h4>
				</div>
				<div class="modal-body">
					<div class="form-group">
						<label for="name" class="control-label">Name:</label>
					...
					<div class="form-group">
						<label for="p_history" class="control-label">ACTION:</label>							
